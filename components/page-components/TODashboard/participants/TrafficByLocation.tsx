        ...
        <ul className="flex flex-col gap-4 py-2">
          <li className="flex items-center gap-5">
            ...
            <div className="flex flex-col">
              <h5 className="font-semibold font-roboto text-white">6.3K</h5>
          ...
          <li className="flex items-center gap-5">
            ...
            {/* Stats */}
            <div className="flex flex-col">
              <h5 className="font-semibold font-roboto text-white">8.45K</h5>
          ...
          <li className="flex items-center gap-5">
            ...
            {/* Stats */}
            <div className="flex flex-col">
              <h5 className="font-semibold font-roboto text-white">3.12K</h5>
          ...
          <li className="flex items-center gap-5">
            ...
            {/* Stats */}
            <div className="flex flex-col">
              <h5 className="font-semibold font-roboto text-white">4.21K</h5>
          ...
          <li className="flex items-center gap-5">
            ...
            {/* Stats */}
            <div className="flex flex-col">
              <h5 className="font-semibold font-roboto text-white">2.55K</h5>
