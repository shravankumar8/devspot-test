alter table "public"."hackathon_faqs" add column "clicks" integer default 0;

alter table "public"."hackathon_resources" add column "clicks" integer not null default 0;

alter table "public"."pending_invitations" disable row level security;

CREATE INDEX idx_hackathon_participants_hackathon_created ON public.hackathon_participants USING btree (hackathon_id, created_at);
