...
create table "public"."page_views" (
    ...
    "page_identifier" character varying(255),
...
alter table "public"."global_hackathon_feedback" add column "comments" text;

alter table "public"."hackathons" add column "multi_projects" boolean default false;
...
CREATE INDEX idx_page_views_identifier_event ON public.page_views USING btree (page_identifier, event_type);

CREATE INDEX idx_page_views_page_identifier ON public.page_views USING btree (page_identifier);

CREATE INDEX idx_page_views_page_type ON public.page_views USING btree (page_type);

CREATE INDEX idx_page_views_type_event_date ON public.page_views USING btree (page_type, event_type, created_at);
...
alter table "public"."page_views" add constraint "page_views_user_id_fkey" FOREIGN KEY (user_id) REFERENCES users(id) not valid;
