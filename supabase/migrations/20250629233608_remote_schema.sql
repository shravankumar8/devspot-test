...
alter table "public"."hackathon_challenge_feedback" add column "challenge_recommendation_rating" integer;

alter table "public"."hackathons" add column "use_judge_bot" boolean not null default true;

alter table "public"."judging_challenges" add column "submitted_winners" boolean not null default false;

alter table "public"."project_challenges" add column "prize_id" integer;

CREATE UNIQUE INDEX one_assigner_per_challenge ON public.judging_challenges USING btree (challenge_id) WHERE (is_winner_assigner = true);

alter table "public"."project_challenges" add constraint "project_challenges_prize_id_fkey" FOREIGN KEY (prize_id) REFERENCES hackathon_challenge_bounties(id) not valid;

alter table "public"."project_challenges" validate constraint "project_challenges_prize_id_fkey";
