alter table "public"."hackathon_challenges" add column "is_round_2_only" boolean not null default false;

alter table "public"."judging_entries" add column "business_score" numeric not null;

alter table "public"."judging_entries" add column "innovation_score" numeric not null;

alter table "public"."judging_entries" add column "technical_score" numeric not null;

alter table "public"."judging_entries" add column "ux_score" numeric not null;

alter table "public"."judging_entries" alter column "score" set data type numeric using "score"::numeric;
