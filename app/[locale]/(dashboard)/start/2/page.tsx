...
const steps: Step[] = [
  { index: 0, link: "/", completed: true, current: false },
  { index: 1, link: "/", completed: false, current: true },
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      <div className="mx-auto max-w-7xl py-24  sm:py-32 ">
        <div className="flex border border-slate-100/20 dark:border-none">
          ...
          <div className="relative isolate overflow-hidden dark:bg-blackest-500 lg:gap-x-20 ">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm font-medium leading-6">
                <span className="bg-white px-2 dark:bg-blackest-500 ">or</span>
              </div>
            </div>
