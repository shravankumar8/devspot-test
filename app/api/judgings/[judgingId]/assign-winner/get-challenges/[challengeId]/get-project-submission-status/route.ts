import { get_challenge_judges_for_winner_assignment, get_project_submission_status } from "@/lib/services/judging";
...
export const GET = async (
  ...
  return await get_project_submission_status(judging_id, challenge_id);
};
