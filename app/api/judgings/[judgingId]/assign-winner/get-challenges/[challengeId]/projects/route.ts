import { get_challenge_projects_for_winner_assignment } from "@/lib/services/judging";
...
export const GET = async (
  ...
  return await get_challenge_projects_for_winner_assignment(judging_id, challenge_id);
};
